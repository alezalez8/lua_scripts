...
* --------------------------------
* Serial: 0 (RX) и 1 (TX)
* Serial1: 19 (RX) и 18 (TX)
* Serial2: 17 (RX) и 16 (TX)
* Serial3: 15 (RX) и 14 (TX)
* --------------------------------
...
void Mav_Request_Data()  // сообщает ПК, какой набор данных и с какой скоростью я хочу получать
{
   ...
   */
   ...
   // MAV_DATA_STREAM DEPRECATED: Replaced by MESSAGE_INTERVAL (2015-06).
...
//#endif
    ...
    if (mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      ...
      // Handle message
      switch (msg.msgid) {              // проверяю, какой параметр приходит и потом обрабатываю его
        ...
        case MAVLINK_MSG_ID_SYS_STATUS:  // #1: SYS_STATUS
          {
            ...
            Serial.println(sys_status.drop_rate_comm);
            mySerial.println("]");
            Serial.println("]");
